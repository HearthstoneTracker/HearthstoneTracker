// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ScreenshotCaptureException.cs" company="">
//   
// </copyright>
// <summary>
//   The screenshot capture exception.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace HearthCap.Core.GameCapture
{
    ...
    /// The screenshot capture exception.
    /// </summary>
    public class ScreenshotCaptureException : Exception
    {
        /// <summary>
        ...
        /// </exception>
        protected ScreenshotCaptureException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
