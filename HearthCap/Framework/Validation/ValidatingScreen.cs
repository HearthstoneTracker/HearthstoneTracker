	...
	public abstract class ValidatingScreen<TViewModel> : Screen, IDataErrorInfo where TViewModel : ValidatingScreen<TViewModel>
	{
		...
		private static readonly Dictionary<string, ValidationAttribute[]> validators =
			(from p in typeof(TViewModel).GetProperties()
			 ...
			 select new System.Collections.Generic.KeyValuePair<string, ValidationAttribute[]> (p.Name, attrs)
		...
		private static readonly Dictionary<string, ValidationGroupAttribute> validationGroup =
			(from p in typeof(TViewModel).GetProperties()
			 ...
			 where  p.GetAttributes<ValidationAttribute>(true).ToArray().Length != 0
			 select new System.Collections.Generic.KeyValuePair<string, ValidationGroupAttribute>
		...
		/// <param name="errors">The list of errrors generated by validators</param>
		protected virtual void OnColumnrror(string columnName, Dictionary<System.Type, string> errors)
		{
			// Does nothing
		}
		...
		public virtual bool IsValid<TProperty>(System.Linq.Expressions.Expression<Func<TProperty>> property)
		{
		...
		{
			var instance = System.Linq.Expressions.Expression.Parameter(typeof(TViewModel), "i");
			var cast = System.Linq.Expressions.Expression.TypeAs(System.Linq.Expressions.Expression.Property(instance, property), typeof(object));
			return (Func<TViewModel, object>)System.Linq.Expressions.Expression.Lambda(cast, instance).Compile();
		}
	}
}
