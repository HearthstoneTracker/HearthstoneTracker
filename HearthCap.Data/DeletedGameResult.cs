// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DeletedGameResult.cs" company="">
//   
// </copyright>
// <summary>
//   The deleted game result.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace HearthCap.Data
{
    ...
    /// The deleted game result.
    /// </summary>
    public class DeletedGameResult : IEntityWithId<Guid>
    {
        /// <summary>
        /// Gets or sets the id.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals((DeletedGameResult)obj);
        }
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        protected bool Equals(DeletedGameResult other)
        {
